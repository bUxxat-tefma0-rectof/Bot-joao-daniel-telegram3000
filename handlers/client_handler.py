...
async def callback(update, context):
    ...
    if d == 'm1':
        ...
        await q.message.reply_document(document=receipt_pdf, filename=f'compra_{pur.purchase_id[:8]}.pdf', caption="📄 Comprovante da sua compra")
        ...
        await q.message.reply_document(document=pdf, filename=f'historico_{u.id}.pdf', caption="📄 Seu histórico detalhado")
...
async def handle_msg(update, context):
    ...
    if db.check_flood(u.id):
        ...
        await update.message.reply_text(ftxt); return
